...
>Lag is a preprocessing class implemented ny Nyoka. When used inside scikit-learn's pipeline, it simply applies  an `aggregation` function for the given features of the dataset by combining `n` number of previous records. It takes two arguments- aggregation and value.
>
