...
class AdapaUtility:
    ...
    def __init__(self):
        self.endpoint = "https://myadapa.zementis.com/adapars/"#os.environ['ADAPA_URL']
        self.username = "anujprotim.baruah@softwareag.com"#os.environ['ADAPA_UN']
        self.password = "zementis"#os.environ['ADAPA_PW']
